...
.l1:
    ...
    lda    #bank(Super_Sonic_STH2_Remix)              ; Change this if the song label changes (and it will most likely).
    sta    <_bl
    lda    #low(Super_Sonic_STH2_Remix)
    sta    <_si
    lda    #high(Super_Sonic_STH2_Remix)
    sta    <_si+1
    jsr    dmf_load_song
