...
; this version can playback different sample rates (by changing the delay) but you cannot
; do anything else really while the audio is being played
...
.l1:
	...
	; we store our data at $4000. Data size of PCM data is $2DCD, giving end address of
	; $6DCD - so looking at MSB, 6D, we go to next value up, 6E and say our audio data is over here
...
.here:  bra	.here	; infinite loop!
	...
	; we adjust the delay depending on the sample rate of the PCM data
ActualDelay:	
