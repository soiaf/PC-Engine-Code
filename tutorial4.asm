; Simple code to display a background image (should display a graphic that looks like the number 0 on-screen)
; This code does the full setup of the system, so should work correctly on a real PC Engine
