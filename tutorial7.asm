; this code gives an example of scrolling the background in the horizontal and vertical
; we setup a 64x64 tile BAT and then using the VDC BXR and BYR registers we move our
; viewpoint around 
...
vdc_table:
 ;	.db $05,$00,$00		; CR	control register
	...
	.db $09,$50,$00		; MWR   size of the virtual screen (64x64 tile BAT)
...
main:   	
	; map in the memory bank
	 ...
	 lda   #bank(importedbatdata)	; addressable memory
	 tam   #page(importedbatdata)	 
...
; blank the background
	...
	tia	importedbatdata,$0002,$1F00 ;Blast the imported BAT to VRAM
...
.ms2:
	...
	lda #$08	;BYR   background vertical scroll offset
	sta  <_vreg ; save this value so VDC interrupt does not overwrite
	sta $0000   ;Register select port
...
.scrollscreenhoriz:
	...
	sta <vsync_check
.ms3:
	bbr0	<vsync_check,.ms4
	bra .ms3
.ms4:

	lda #$07	;BXR   background horizontal scroll offset
	sta  <_vreg ; save this value so VDC interrupt does not overwrite
	sta $0000   ;Register select port
